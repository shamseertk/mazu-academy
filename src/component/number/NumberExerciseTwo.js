...
class NumberExerciseTwo extends React.Component{
  ...
  initiateValues = () => {
    const availableWords = JSON.parse(JSON.stringify(arabicNumbers));
    const originalAvailWords = JSON.parse(JSON.stringify(arabicNumbers));
...
export default withStyles(styles)(NumberExerciseTwo);
